  ...
  <form class="mx-auto w-full max-w-lg my-4" method="POST">
    <div class="flex flex-wrap -mx-3 mb-6">
      <div class="w-full md:w-100 px-3 mb-6 md:mb-0">
        ...
        <input class="block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-2 px-2 mb-3 leading-tight text-sm focus:outline-none focus:bg-white" name="recipe_title" type="text">
